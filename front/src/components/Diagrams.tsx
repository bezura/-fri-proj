  ...
  import {
    ...
    communicationMermaidDiagram,
    compositeStructureMermaidDiagram,
    interactionOverviewMermaidDiagram,
    objectMermaidDiagram,
  } from "../mermaid"
...
<Diagram
  name="Диаграмма коммуникации (Communication Diagram)"
  description="Диаграмма коммуникации показывает взаимодействие объектов через передачу сообщений с акцентом на структурную организацию участвующих объектов. Эта диаграмма иллюстрирует процесс обработки заявки на отпуск."
  mermaidCode={communicationMermaidDiagram}
/>

<Diagram
  name="Диаграмма композитной структуры (Composite Structure Diagram)"
  description="Диаграмма композитной структуры показывает внутреннюю структуру класса или компонента, включая порты, части и их взаимосвязи. Эта диаграмма представляет структуру HR-модуля системы."
  mermaidCode={compositeStructureMermaidDiagram}
/>

<Diagram
  name="Диаграмма обзора взаимодействия (Interaction Overview Diagram)"
  description="Диаграмма обзора взаимодействия комбинирует элементы диаграммы активности и последовательности, показывая поток управления между различными взаимодействиями в процессе найма сотрудника."
  mermaidCode={interactionOverviewMermaidDiagram}
/>

<Diagram
  name="Диаграмма объектов (Object Diagram)"
  description="Диаграмма объектов показывает экземпляры классов в определенный момент времени с конкретными значениями атрибутов. Эта диаграмма представляет снимок системы в процессе расчета зарплаты."
  mermaidCode={objectMermaidDiagram}
/>
